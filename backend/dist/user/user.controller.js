...
let UserController = class UserController {
    ...
    registeruser(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const createUserDto = { fullName: req.body.name, email: req.body.email, accountAddress: req.body.accountAddress };
            return yield this.userService.create(createUserDto);
        });
    }
    creatorrequestchange(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const resetUserDto = { fullName: req.body.Name, email: req.body.Email, socialMedia: req.body.Social, accountAddress: req.body.AccountAddress };
            return yield this.userService.resetUserData(resetUserDto);
        });
    }
    finduserbyaccount(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const findData = { account: req.body.accountAddress };
            return yield this.userService.findByAccount(findData);
        });
    }
    creatoraccepted(req) {
        return __awaiter(this, void 0, void 0, function* () {
            let tempInviteCode;
            if (req.body.accepted == 'OK') {
                tempInviteCode = uuid_1.v4();
                const resetCreatorDataDto = { email: req.body.email, inviteCode: tempInviteCode };
                return yield this.userService.resetCreatorData(resetCreatorDataDto);
            }
            return false;
        });
    }
    verifyUrl(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userService.verifyEmailFromDatabase(req.body.verifyToken);
        });
    }
    getUsers() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.userService.getAllUserData();
        });
    }
...
__decorate([
    common_1.Post('creatorrequest'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "creatorrequestchange", null);
__decorate([
    common_1.Post('find-user'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "finduserbyaccount", null);
__decorate([
    common_1.Post('creatormanage'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "creatoraccepted", null);
__decorate([
    common_1.Post('url-verify'),
    __param(0, common_1.Req()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "verifyUrl", null);
__decorate([
