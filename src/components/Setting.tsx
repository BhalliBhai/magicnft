...
const Setting = ({ setNetwork, setChain }: IProps) => {
  ...
  return (
    <div className={styles.setting}>
      <div className={styles.row} style={{ left: '0%', width: '60%'}}>
        <label htmlFor="network" className={styles.label}>
          Web3Auth Network
        </label>
        <select id="network" onChange={networkChangeHandler} className={styles.select} disabled={isLoggedIn} style={{width: '30%'}}>
      ...
      <div className={styles.row} style={{ left: '50%', width: '40%'}}>
        <label htmlFor="network" className={styles.label}>
        Blockchain
        </label>
        <select onChange={chainChangeHandler} className={styles.select} disabled={isLoggedIn} style={{width: '60%'}}>
