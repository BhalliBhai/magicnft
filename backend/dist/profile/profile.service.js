...
let ProfileService = class ProfileService {
    ...
    create_save(saveProfileDto) {
        return __awaiter(this, void 0, void 0, function* () {
            const tempProfile = yield this.profileModel.findOne({ email: saveProfileDto.email });
            if (tempProfile) {
                ...
                return yield tempProfile.save();
            }
            else {
                const createPro = new this.profileModel(saveProfileDto);
                return yield createPro.save();
            }
        });
    }
    get_profile(email) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.profileModel.findOne({ email: email });
        });
    }
};
